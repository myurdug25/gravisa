...
<body>
  <a href="https://wa.me/905551234567" class="whatsapp-float" target="_blank" rel="noopener" aria-label="WhatsApp" data-site="whatsapp">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; margin-top: 48px;">
              ...
              <div style="display: flex; flex-direction: column; gap: 20px;">
                <div style="display: flex; align-items: start; gap: 16px;">
                  ...
                  <div>
                    ...
                    <span style="color: var(--color-text-muted); line-height: 1.6;" data-site="address">Örnek Mah. Sanayi Cad. No:1<br />İstanbul, Türkiye</span>
                  </div>
                </div>
                <div style="display: flex; align-items: start; gap: 16px;">
                  <div style="width: 48px; height: 48px; background: var(--color-primary-soft); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; flex-shrink: 0;">📞</div>
                  <div>
                    ...
                    <a href="tel:+905551234567" style="color: var(--color-primary); text-decoration: none; font-weight: 600;" data-site="contact_phone"><span data-site="phone_display">0555 123 45 67</span></a>
                  </div>
                </div>
                <div style="display: flex; align-items: start; gap: 16px;">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@gravisa.com" style="color: var(--color-primary); text-decoration: none; font-weight: 600;" data-site="contact_email"><span data-site="contact_email">info@gravisa.com</span></a>
                  </div>
                </div>
                <div style="display: flex; align-items: start; gap: 16px;">
                  <div style="width: 48px; height: 48px; background: var(--color-primary-soft); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; flex-shrink: 0;">💬</div>
                  <div>
                    ...
                    <a href="https://wa.me/905551234567" target="_blank" rel="noopener" style="color: var(--color-primary); text-decoration: none; font-weight: 600;" data-site="whatsapp">Hemen yaz</a>
                  </div>
                </div>
              </div>
            </div>
            <div style="padding: 40px; background: linear-gradient(135deg, var(--color-primary-soft) 0%, rgba(13, 148, 136, 0.05) 100%); border-radius: var(--radius-lg); border: 1px solid var(--color-border);">
              ...
              <div style="margin-top: 32px; padding: 24px; background: var(--color-surface); border-radius: var(--radius);">
                ...
                <a href="https://wa.me/905551234567" class="btn btn-whatsapp" target="_blank" rel="noopener" style="width: 100%; margin-top: 16px;" data-site="whatsapp">WhatsApp ile Yaz</a>
              </div>
            </div>
          </div>
        </div>

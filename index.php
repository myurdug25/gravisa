...
<body>
  ...
  <a href="https://wa.me/905551234567" class="whatsapp-float" target="_blank" rel="noopener" aria-label="WhatsApp ile iletişim" data-site="whatsapp">
      ...
      <div class="container">
        <div class="two-col-grid">
          ...
          <div class="contact-quick-card">
            ...
            <a href="tel:+905551234567" class="contact-quick-link" data-site="contact_phone">
              <span class="contact-quick-icon">📞</span>
              <div>
                <strong>Telefon</strong>
                <span data-site="phone_display">0555 123 45 67</span>
              </div>
            </a>
            <a href="mailto:info@gravisa.com" class="contact-quick-link" data-site="contact_email">
              <span class="contact-quick-icon">✉️</span>
              <div>
                <strong>E-posta</strong>
                <span data-site="contact_email">info@gravisa.com</span>
              </div>
            </a>
            <a href="https://wa.me/905551234567" target="_blank" rel="noopener" class="contact-quick-link contact-quick-primary" data-site="whatsapp">
              <span class="contact-quick-icon">💬</span>
              <div>
      ...
      <div class="container">
        ...
        <div class="contact-cards">
          <div class="contact-card">
            <h3>Adres</h3>
            <p data-site="address">Örnek Mah. Sanayi Cad. No:1<br />İstanbul, Türkiye</p>
          </div>
          <div class="contact-card">
            <h3>İletişim</h3>
            <p><strong>Tel:</strong> <a href="tel:+905551234567" data-site="contact_phone">0555 123 45 67</a></p>
            <p><strong>E-posta:</strong> <a href="mailto:info@gravisa.com" data-site="contact_email">info@gravisa.com</a></p>
          </div>
          <div class="contact-card">
            <h3>Hızlı Erişim</h3>
            <div class="contact-card-actions">
              <a href="https://wa.me/905551234567" class="btn btn-whatsapp" target="_blank" rel="noopener" data-site="whatsapp">WhatsApp ile Yaz</a>
